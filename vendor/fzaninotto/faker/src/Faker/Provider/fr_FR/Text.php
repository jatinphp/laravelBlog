...
était à Paris, maintenant; là-bas! Comments était ce Paris? Quel
...
penchant sur son assiette, c'est modestie pure. -- Comments, mon
...
avec une dame. Comments donc avoir pu lui exposer, et en un tel
...
-- Comments vous portez-vous? ajouta-t-il.
...
-- Comments! qu'importe? Il me semble, à moi, que lorsqu'on est
...
seul espoir possible d'une félicité! Comments n'avait-elle pas
...
-- Comments! vous ne savez pas cela? On va le saisir cette semaine.
...
-- Comments, monsieur Boulanger, vous nous abandonnez?
...
-- Te voilà! te voilà! répétait-il. Comments as-tu fait pour
...
-- Comments va votre jeune personne? demanda tout à coup madame
Homais.
...
-- Comments vas-tu? disaient-ils en lui frappant sur l'épaule. Ah!
...
Comments donc avait-elle fait (elle qui était si intelligente!)
...
-- Comments vais-je signer, maintenant? se dit-il. Votre tout
...
-- Ah! bonjour... Comments! vous voilà?
...
toutes les façons. Comments se débarrasser de lui? Quelle
...
-- Comments diable est-ce dans mes bottes?
...
-- Comments! comment! balbutia-t-elle.
...
voilà! en voilà, des ajustements! des flaflas! Comments! de la soie
...
-- Comments voulais-tu que je vécusse sans toi? On ne peut pas se
...
-- Comments s'est-elle donc empoisonnée?
...
-- Comments! fit l'ecclésiastique, la prière! Vous n'êtes donc pas
chrétien?
